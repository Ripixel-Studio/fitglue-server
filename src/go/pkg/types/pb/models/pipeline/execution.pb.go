...
type PipelineRun struct {
	...
	// GCS URI of the durable, layered ActivityRecord written on pipeline completion
	// (fitglue.models.activity.ActivityRecord as protojson). Empty for legacy runs
	// created before layered storage, which fall back to enriched_event_uri.
	ActivityRecordUri string `protobuf:"bytes,27,opt,name=activity_record_uri,json=activityRecordUri,proto3" json:"activity_record_uri,omitempty"`
	// When the raw provider payload at original_payload_uri is pruned (ingest + 30d,
	// spec DECISION 1a). Informational; deletion is enforced by a GCS lifecycle rule
	// on the payloads/ prefix. After this, reprocessing relies on a re-pull.
	RawPayloadExpiresAt *timestamppb.Timestamp `protobuf:"bytes,28,opt,name=raw_payload_expires_at,json=rawPayloadExpiresAt,proto3" json:"raw_payload_expires_at,omitempty"`
...
func (x *PipelineRun) GetActivityRecordUri() string {
	if x != nil {
		return x.ActivityRecordUri
	}
	return ""
}

func (x *PipelineRun) GetRawPayloadExpiresAt() *timestamppb.Timestamp {
	if x != nil {
...
const file_models_pipeline_execution_proto_rawDesc = "" +
	"\n" +
	"\x1fmodels/pipeline/execution.proto\x12\x17fitglue.models.pipeline\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cmodels/activity/source.proto\x1a\x1cmodels/plugin/provider.proto\"\xa4\t\n" +
	...
	"\x13activity_record_uri\x18\x1b \x01(\tR\x11activityRecordUri\x12O\n" +
	"\x16raw_payload_expires_at\x18\x1c \x01(\v2\x1a.google.protobuf.TimestampR\x13rawPayloadExpiresAt\x12B\n" +
...
var file_models_pipeline_execution_proto_depIdxs = []int32{
	...
	13, // 7: fitglue.models.pipeline.PipelineRun.raw_payload_expires_at:type_name -> google.protobuf.Timestamp
	6,  // 8: fitglue.models.pipeline.PipelineRun.steps:type_name -> fitglue.models.pipeline.ExecutionStep
	1,  // 9: fitglue.models.pipeline.ExecutionStep.kind:type_name -> fitglue.models.pipeline.ExecutionStepKind
	2,  // 10: fitglue.models.pipeline.ExecutionStep.status:type_name -> fitglue.models.pipeline.ExecutionStepStatus
	10, // 11: fitglue.models.pipeline.ExecutionStep.metadata:type_name -> fitglue.models.pipeline.ExecutionStep.MetadataEntry
	11, // 12: fitglue.models.pipeline.BoosterExecution.metadata:type_name -> fitglue.models.pipeline.BoosterExecution.MetadataEntry
	2,  // 13: fitglue.models.pipeline.BoosterExecution.status:type_name -> fitglue.models.pipeline.ExecutionStepStatus
	14, // 14: fitglue.models.pipeline.DestinationOutcome.destination:type_name -> fitglue.models.plugin.DestinationType
	3,  // 15: fitglue.models.pipeline.DestinationOutcome.status:type_name -> fitglue.models.pipeline.DestinationStatus
	13, // 16: fitglue.models.pipeline.DestinationOutcome.completed_at:type_name -> google.protobuf.Timestamp
	4,  // 17: fitglue.models.pipeline.ExecutionRecord.status:type_name -> fitglue.models.pipeline.ExecutionStatus
	13, // 18: fitglue.models.pipeline.ExecutionRecord.timestamp:type_name -> google.protobuf.Timestamp
	13, // 19: fitglue.models.pipeline.ExecutionRecord.start_time:type_name -> google.protobuf.Timestamp
	13, // 20: fitglue.models.pipeline.ExecutionRecord.end_time:type_name -> google.protobuf.Timestamp
	13, // 21: fitglue.models.pipeline.ExecutionRecord.expire_at:type_name -> google.protobuf.Timestamp
