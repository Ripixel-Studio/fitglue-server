...
type DetailedSegment struct {
	...
	// ClimbCategory The category of the climb [0, 5]. Higher is harder ie. 5 is Hors catégorie, 0 is uncategorized in climb_category.
...
type UpdateActivityByIdJSONBody struct {
	...
	// GearId Identifier for the gear associated with the activity. ‘none’ clears gear from activity
